...
#define ETHER_MAX_FRAME(ifp, etype, hasfcs)                                    \
	((ifp)->if_mtu + ETHER_HDR_LEN + ((hasfcs) ? ETHER_CRC_LEN : 0)            \
...
/* 0x8046 - 0x8047	   AT&T */
#define ETHERTYPE_DECAM                                                        \
	0x8048 /* DEC Availability Manager for Distributed Systems DECamds (but someone at DEC says not) */
...
#define ETHERTYPE_XNSSM                                                        \
	0x9001 /* 3Com (Formerly Bridge Communications), XNS Systems Management */
#define ETHERTYPE_TCPSM                                                        \
	0x9002 /* 3Com (Formerly Bridge Communications), TCP/IP Systems Management */
#define ETHERTYPE_BCLOOP                                                       \
	0x9003 /* 3Com (Formerly Bridge Communications), loopback detection */
...
void ether_vlan_mtap(struct bpf_if *, struct mbuf *, void *, u_int);
