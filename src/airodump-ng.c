						   ...
						   int cardnum)
{
	...
	if (st_cur == NULL)
	{
		...
		memcpy(st_cur->gps_loc_min, G.gps_loc, sizeof(float) * 5);
		memcpy(st_cur->gps_loc_max, G.gps_loc, sizeof(float) * 5);
		memcpy(st_cur->gps_loc_best, G.gps_loc, sizeof(float) * 5);
