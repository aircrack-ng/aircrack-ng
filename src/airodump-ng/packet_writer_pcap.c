...
static void context_free(
    struct pcap_writer_context_st * const context)
{
    free(context);
}

static void pcap_write(
    void * const priv,
...
static void pcap_context_close(
    struct pcap_writer_context_st * const context)
{
    if (context == NULL)
    {
...
struct pcap_writer_context_st * pcap_context_open(
    char const * const filename)
{
    bool success;
    struct pcap_writer_context_st * context =
