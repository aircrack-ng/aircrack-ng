...
*/
int attack_check(unsigned char *bssid,
				 char *essid,
				 unsigned char *capa,
				 struct wif *wi)
{
...
void send_fragments(unsigned char *packet,
					int packet_len,
					unsigned char *iv,
...
int set_clear_arp(unsigned char *buf,
				  unsigned char *smac,
...
int make_arp_request(unsigned char *h80211,
					 unsigned char *bssid,
