...
EXPORT int transition_set_channel(struct wif * swip, const int chan, const uint8_t htval)
{
...
EXPORT int transition_set_freq(struct wif * swip, const int freq, const uint8_t htval)
{
