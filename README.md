...
* **with-static-simd=<SIMD>**: Compile a single optimization in aircrack-ng binary. Valid SIMD options: x86-sse2,
                    x86-avx, x86-avx2, x86-avx512, ppc-altivec, ppc-power8, arm-neon, arm-asimd. The default
