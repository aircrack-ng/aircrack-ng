...
airdecap-ng -e test -p biscotte "${tmpdir}/wpa.cap" | grep "Number of decrypted WPA  packets         2"
...
airdecap-ng -e linksys -p dictionary "${tmpdir}/wpa-psk-linksys.cap" | grep "Number of decrypted WPA  packets        53"
...
airdecap-ng -e linksys -p dictionary "${tmpdir}/wpa2-psk-linksys.cap" | grep "Number of decrypted WPA  packets        25"
