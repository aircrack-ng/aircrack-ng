...
exec cp test/wep_64_ptw_01.cap pipe.cap

spawn ./aircrack-ng -X pipe.cap
...
exec cat test/wep_64_ptw_02.cap >> pipe.cap
expect "Failed. Next try with 10000 IVs." { sleep 2 }

exec cat test/wep_64_ptw_03.cap >> pipe.cap
exec cat test/wep_64_ptw_04.cap >> pipe.cap
