...
if  __name__ == "__main__":
	...
	parser.add_option("-i", "--file", dest="filename", nargs=2 ,help="Input files to read data from requires two arguments")
	...
	if outfile == None:
		...
		print "You must provide two file names to join. IE... -i foo1.txt foo2.txt\n"
		showBanner()
		sys.exit(1)
