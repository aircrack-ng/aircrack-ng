...
class installAirdrop:
	def __init__(self):
		...
		yno = input ("Continue with installer? (y/n): ")
		if yno == "y":
		...
		yno = input ("Install airdrop-ng? (y/n): ")
		if yno == "y":
			self.install()
		else:
...
class installLorcon:
	def __init__(self):
		yno = input ("Would you like to install lorcon? (y/n): ")
		if yno == "y":
...
class installPylorcon:
	def __init__(self):
		yno = input ("Would you like to install pylorcon? (y/n): ")
		if yno == "y":

			import urllib.request, urllib.parse, urllib.error
			urllib.request.urlretrieve("http://pylorcon.googlecode.com/files/pylorcon-3.tar.bz2", "pylorcon-3.tar.bz2")
